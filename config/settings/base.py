...
LOCAL_APPS = [
    "bcc.users.apps.UsersConfig",
    "bcc.cms.apps.CmsConfig"
...
MIGRATION_MODULES = {"sites": "bcc.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "bcc.utils.context_processors.settings_context",
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "bcc.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "bcc.users.adapters.SocialAccountAdapter"
# django-compressor
# ------------------------------------------------------------------------------
